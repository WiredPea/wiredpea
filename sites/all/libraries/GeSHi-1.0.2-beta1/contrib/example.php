...
if ( isset($_POST['submit']) )
{
	...
	$geshi->set_overall_style('font-size: 90%; color: #000066; border: 1px solid #d0d0d0; background-color: #f0f0f0;', true);
	$geshi->set_line_style('font: normal normal 95% \'Courier New\', Courier, monospace; color: #003030;', 'font: bold normal 95% \'Courier New\', Courier, monospace; color: #006060;', true);
}
?>
...
have that language file highlighted by PHP</p>
<?php
if ( isset($_POST['submit']) )
{
...
{
	if ( $file == '..' || $file == '.' || !stristr($file, '.') ) continue;
...
<div id="footer">GeSHi &copy; Oracle, 2004, released under the GNU GPL<br />
