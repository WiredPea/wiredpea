 ...
 * Last Modified: $Date: 2004/10/09 02:56:32 $
 *
...
class GeSHi
{
	 ...
	 * get_language_name()
	 * ---------------
	 * Gets a human-readable language name (thanks to ________
	 * for the idea :))
	 */
	...
	{
		if ( (isset($this->language_data['URLS'][$group]) && $this->language_data['URLS'][$group] != '') && substr($keyword, strlen($keyword) - 4, 4) != '&gt;' )
		{
