...
class __TwigTemplate_745f3694df976ded3085843daa0b9d25a8e8e907e7240c9a7572f644754dd5f0 extends Twig_Template
{
    ...
    {
        $__internal_70fed53d56949c2b08bc0f9beabdf4dd8959374753d1d6d083f1df86841bf9b2 = $this->env->getExtension("Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension");
        $__internal_70fed53d56949c2b08bc0f9beabdf4dd8959374753d1d6d083f1df86841bf9b2->enter($__internal_70fed53d56949c2b08bc0f9beabdf4dd8959374753d1d6d083f1df86841bf9b2_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "@bolt/_nav/_secondary-content.twig"));
...
$context["slug"]) . ":create"));
                // line 16
                echo "        ";
                $context["sub"] = array(0 => ($context["sub_view"] ?? null), 1 => ($context["sub_new"] ?? null), 2 => "-");
                // line 17
                echo "
        ";
                // line 19
            ...
            ";
                    ...
                    $context['records'] =                     $template_storage->getContent(($context["slug"] ?? null), array("limit" => 4, "hydrate" => false, "order" => "-datechanged") );
                    // line 22
                    echo "            ";
                    $context['_parent'] = $context;
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["record"]) {
                        // line 23
                        echo "                ";
                        $context["sub"] = twig_array_merge(($context["sub"] ?? null), array(0 => array("icon" => (($this->getAttribute(                        // line 25
...
$context["slug"], "id" => $this->getAttribute($context["record"], "id", array()))))));
            ...
            ";
                    ...
                    // line 33
                    echo "            ";
                    $context["active"] = ((($context["page_nav"] ?? null) == "Content/*") && ((($this->getAttribute($this->getAttribute(($context["context"] ?? null), "contenttype", array(), "any", false, true), "slug", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute(($context["context"] ?? null), "contenttype", array(), "any", false, true), "slug", array()))) : ("")) == $context["slug"]));
                    // line 34
                    echo "
            ";
                    // line 35
                    echo twig_escape_filter($this->env, $this->getAttribute(($context["nav"] ?? null), "submenu", array(0 => (($this->getAttribute($context["contenttype"], "icon_many", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($context["contenttype"], "icon_many", array()), "")) : ("")), 1 => ($context["label"] ?? null), 2 => ($context["sub"] ?? null), 3 => ($context["active"] ?? null), 4 => true), "method"), "html", null, true);
                    echo "
...
$context["slug"])));
            ...
            ";
                    ...
                    // line 47
                    echo "            ";
                    if ($this->getAttribute(($context["definedSubs"] ?? null), ($context["key"] ?? null), array(), "array", true, true)) {
                        // line 48
                        echo "                ";
                        $context['_parent'] = $context;
                        $context['_seq'] = twig_ensure_traversable(($context["definedSubs"] ?? null));
                        foreach ($context['_seq'] as $context["submenuName"] => $context["submenudef"]) {
                            // line 49
                            echo "                    ";
                            if ((($context["key"] ?? null) == $context["submenuName"])) {
                                // line 50
                                echo "                        ";
                                $context["submenudef"] = twig_array_merge($context["submenudef"], array(0 => ($context["sub_view"] ?? null)));
                                // line 51
                                echo "                        ";
                                $context["definedSubs"] = twig_array_merge(($context["definedSubs"] ?? null), array($context["submenuName"] => $context["submenudef"]));
                                // line 52
                                echo "                    ";
                            }
                            // line 53
                        ...
                        // line 55
                        echo "                ";
                        $context["definedSubs"] = twig_array_merge(($context["definedSubs"] ?? null), array(($context["key"] ?? null) => array(0 => ($context["sub_view"] ?? null))));
                        // line 56
                        echo "            ";
                    }
                    // line 57
...
";
        ...
        foreach ($context['_seq'] as $context["submenuName"] => $context["submenudef"]) {
            ...
            // line 65
            echo "    ";
            echo twig_escape_filter($this->env, $this->getAttribute(($context["nav"] ?? null), "submenu", array(0 => "fa:th-list", 1 => $context["submenuName"], 2 => $context["submenudef"], 3 => false, 4 => false, 5 => false, 6 => true), "method"), "html", null, true);
            echo "
";
        }
        $_parent = $context['_parent'];
        ...
        $__internal_70fed53d56949c2b08bc0f9beabdf4dd8959374753d1d6d083f1df86841bf9b2->leave($__internal_70fed53d56949c2b08bc0f9beabdf4dd8959374753d1d6d083f1df86841bf9b2_prof);
