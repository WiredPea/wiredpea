...
class __TwigTemplate_b2f1c478b17e415450153dd9bef778e793d2551d898053804f33a7b1b92c344f extends Twig_Template
{
    ...
    {
        $__internal_98f8866d1416ccc00c9ce6bc856abc583266f7e3ed2ca39ee854febf914e9f0c = $this->env->getExtension("Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension");
        $__internal_98f8866d1416ccc00c9ce6bc856abc583266f7e3ed2ca39ee854febf914e9f0c->enter($__internal_98f8866d1416ccc00c9ce6bc856abc583266f7e3ed2ca39ee854febf914e9f0c_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "@bolt/_nav/_secondary.twig"));
...
<ul class=\"nav\">
    ";
        // line 4
        if ( !(null === $this->getAttribute($this->getAttribute(($context["app"] ?? null), "session", array()), "get", array(0 => "authentication"), "method"))) {
            // line 5
            echo "
        ";
            // line 7
        ...
        ";
            // line 10
            echo "        ";
            echo $context["nav"]->getlink("fa:dashboard", $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("general.phrase.dashboard"), "dashboard", (($context["page_nav"] ?? null) == "Dashboard"));
            echo "
        ...
        ";
            ...
            if ($this->env->getExtension('Bolt\Twig\TwigExtension')->isAllowed("settings")) {
                ...
                // line 27
                echo "            ";
                if (($this->getAttribute($this->getAttribute($this->getAttribute(($context["app"] ?? null), "menu.admin", array(), "array"), "get", array(0 => "extend"), "method"), "children", array()) || $this->env->getExtension('Bolt\Twig\TwigExtension')->isAllowed("extensions||extensions:config"))) {
                    // line 28
                    echo "                ";
                    ob_start();
            ...
            ";
                // line 33
                if ((((trim(($context["nav_config"] ?? null)) || trim(($context["nav_files"] ?? null))) || trim(($context["nav_trans"] ?? null))) || trim(($context["nav_extend"] ?? null)))) {
                    // line 34
                    echo "                ";
                ...
                ";
                    // line 36
                    echo twig_escape_filter($this->env, ($context["nav_config"] ?? null), "html", null, true);
                    echo "
                ";
                    // line 37
                    echo twig_escape_filter($this->env, ($context["nav_files"] ?? null), "html", null, true);
                    echo "
                ";
                    // line 38
                    echo twig_escape_filter($this->env, ($context["nav_trans"] ?? null), "html", null, true);
                    echo "
                ";
                    // line 39
                    echo twig_escape_filter($this->env, ($context["nav_extend"] ?? null), "html", null, true);
                    echo "
            ";
                }
                // line 41
...
";
        ...
        $__internal_98f8866d1416ccc00c9ce6bc856abc583266f7e3ed2ca39ee854febf914e9f0c->leave($__internal_98f8866d1416ccc00c9ce6bc856abc583266f7e3ed2ca39ee854febf914e9f0c_prof);
